...
public class OtherProfsAdapter extends RecyclerView.Adapter<OtherProfsAdapter.FeaturedViewHolder>{
    ...
    public OtherProfsAdapter(ArrayList<MyCardHelperClass> dataProfs) {
        this.dataProfs = dataProfs;
    }

    public static class FeaturedViewHolder extends RecyclerView.ViewHolder {

        ImageView image,delete_button;
        TextView name, desc;
